...
docker image push ${accountId}.dkr.ecr.${region}.amazonaws.com/${project}:latest --region ${region}
docker image push ${accountId}.dkr.ecr.${region}.amazonaws.com/${project}:${tag} --region ${region}
"""
}
